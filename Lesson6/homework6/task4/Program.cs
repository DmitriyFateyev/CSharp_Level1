...
namespace CopySamples
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("FileStream. Milliseconds:{0}", FileStreamSample("D:\\tmp\\bigdata0.bin", size));
            Console.WriteLine("BinaryStream. Milliseconds:{0}", BinaryStreamSample("D:\\tmp\\bigdata1.bin", size));
            Console.WriteLine("StreamWriter. Milliseconds:{0}", StreamWriterSample("D:\\tmp\\bigdata2.bin", size));
            Console.WriteLine("BufferedStream. Milliseconds:{0}", BufferedStreamSample("D:\\tmp\\bigdata3.bin", size));
